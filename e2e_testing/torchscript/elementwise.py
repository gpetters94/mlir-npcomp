...
class ElementwiseCmpLeModule(torch.nn.Module):
    def __init__(self):
        super().__init__()
...
@register_test_case(module_factory=lambda: ElementwiseCmpLeModule())
def ElementwiseCmpLeModule_basic(module, tu: TestUtils):
